...
public class BodyFatCalculator {
	...
	public static double calculateFat(double weight, double height, double neck, double waist) {
		double fatPercent;
	...
	public static double calculateFat(double weight, double height, double neck, double waist, double hip) {
		double fatPercent;
	...
	public String calculate(double weight, double height, double neck, double waist)
    {
    	double fat = calculateFat(weight, height, neck, waist);
//    	sc.close();
    	if(fat == -1 || fat < 2)
	...
	public String calculate(double weight, double height, double neck, double waist, double hip)
    {
    	double fat = calculateFat(weight, height , neck, waist, hip);
//    	sc.close();
    	if(fat == -1 || fat < 10)
    		return "Invalid Inputs";
